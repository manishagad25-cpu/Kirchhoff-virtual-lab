 ...
 */
export const scriptAssetsParsers = new Map();
/**
 *
 ...
 */
export function registerScriptAssetParser(extension, parser) {
 ...
 * @internal
 */
export async function _preloadScriptsAssets(rootUrl, scene, scriptsMap) {
