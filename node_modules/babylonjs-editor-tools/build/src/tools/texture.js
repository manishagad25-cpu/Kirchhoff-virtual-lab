 ...
 */
export function addExcludedCompressedTexture(engine, textureUrl) {
 ...
 */
export function applyTexturesQuality(quality, scene, rootUrl) {
 ...
 */
export function getTextureUrl(sourceProperty, scene) {
