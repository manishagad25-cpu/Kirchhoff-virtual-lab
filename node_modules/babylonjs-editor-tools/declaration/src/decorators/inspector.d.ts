...
export declare function visibleAsAsset(assetType: VisibleInspectorDecoratorAssetPossibleTypes, label?: string, configuration?: Omit<VisibleInspectorDecoratorAssetConfiguration, "type" | "assetType">): (target: any, propertyKey: string | Symbol) => void;
