 ...
 * @category Assets
 */
class HDRTextureAssetLoader {
    static init(loadingManager) {
    ...
    static async loadHDRTexture(url) {
        // Normalize extension
        ...
        if (!isEXR && !isHDR) {
            ...
            return Promise.reject(new Error(`Unsupported HDR texture extension in url: ${url}`));
        }
...
export { HDRTextureAssetLoader };
//# sourceMappingURL=hdr-texture-loader.js.map
