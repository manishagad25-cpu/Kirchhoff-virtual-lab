...
class EnvironmentSystem extends createSystem({
    ...
    constructor() {
        ...
        this.onXRSessionEnd = () => {
            var _a;
            (_a = this.resetListenerCleanup) === null || _a === void 0 ? void 0 : _a.call(this);
            this.resetListenerCleanup = null;
            this.recenterYawOffset = 0;
            this.needsResetListener = false;
        };
    ...
    updateBackgroundProps(entity) {
        ...
        if (rot) {
            (_c = this.scene.backgroundRotation) === null || _c === void 0 ? void 0 : _c.set(rot[0] || 0, (rot[1] || 0) + this.recenterYawOffset, rot[2] || 0);
        }
    }
    ...
    updateIBLProps(entity) {
        ...
        if (rot) {
            (_b = this.scene.environmentRotation) === null || _b === void 0 ? void 0 : _b.set(rot[0] || 0, (rot[1] || 0) + this.recenterYawOffset, rot[2] || 0);
        }
    }
    ...
    applyRecenterCompensation() {
        var _a, _b;
        for (const entity of this.queries.iblTextures.entities) {
            const rot = entity.getVectorView(IBLTexture, 'rotation');
            if (rot) {
                (_a = this.scene.environmentRotation) === null || _a === void 0 ? void 0 : _a.set(rot[0] || 0, (rot[1] || 0) + this.recenterYawOffset, rot[2] || 0);
            }
            break;
        }
        for (const entity of this.queries.domeTextures.entities) {
            const rot = entity.getVectorView(DomeTexture, 'rotation');
            if (rot) {
                (_b = this.scene.backgroundRotation) === null || _b === void 0 ? void 0 : _b.set(rot[0] || 0, (rot[1] || 0) + this.recenterYawOffset, rot[2] || 0);
            }
            break;
        }
    }
