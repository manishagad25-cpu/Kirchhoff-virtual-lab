...
export declare class EnvironmentSystem extends EnvironmentSystem_base {
    ...
    private tmpColor;
    private recenterYawOffset;
    private resetListenerCleanup;
    private needsResetListener;
    init(): void;
    update(): void;
    ...
    private attachResetListener;
    private onXRSessionEnd;
    private onReferenceSpaceReset;
    private applyRecenterCompensation;
