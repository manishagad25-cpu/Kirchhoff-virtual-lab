...
import '../environment/environment-system.js';
 ...
 * @category Scene
 */
class LevelSystem extends createSystem({
    ...
    startLevelChange(url) {
        ...
        const newRoot = this.world.createTransformEntity(undefined, {
            parent: this.world.sceneEntity,
        });
        ...
        void doLoad
            ...
            try {
                if (this.config.defaultLighting.value) {
                    const hasDome = newRoot.hasComponent(DomeTexture) ||
                        newRoot.hasComponent(DomeGradient);
                    const hasIBL = newRoot.hasComponent(IBLTexture) ||
