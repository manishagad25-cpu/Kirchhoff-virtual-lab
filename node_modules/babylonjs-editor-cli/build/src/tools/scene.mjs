...
export async function ensureSceneDirectories(scenePath) {
    await Promise.all([
...
export async function readSceneDirectories(scenePath) {
    const [nodesFiles, meshesFiles, lodsFiles, lightsFiles, cameraFiles, skeletonFiles, shadowGeneratorFiles, sceneLinkFiles, guiFiles, soundFiles, soundNodeFiles, particleSystemFiles, morphTargetManagerFiles, morphTargetFiles, animationGroupFiles, spriteMapFiles, spriteManagerFiles, geometryFiles, nodeParticleSystemSetFiles,] = await Promise.all([
