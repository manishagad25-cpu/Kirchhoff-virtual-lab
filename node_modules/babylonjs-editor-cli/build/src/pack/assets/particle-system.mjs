...
export async function processExportedNodeParticleSystemSet(absolutePath, options) {
...
export async function extractParticleSystemTextures(particleSystemData, options) {
...
export async function extractNodeParticleSystemSetTextures(particleSystemData, options) {
...
//# sourceMappingURL=particle-system.mjs.map