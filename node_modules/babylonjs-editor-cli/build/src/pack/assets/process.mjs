...
const supportedImagesExtensions = [".jpg", ".jpeg", ".webp", ".png", ".bmp"];
const supportedCubeTexturesExtensions = [".env", ".dds", ".hdr"];
const supportedAudioExtensions = [".mp3", ".wav", ".wave", ".ogg"];
const supportedJsonExtensions = [".material", ".gui", ".cinematic", ".npss", ".ragdoll", ".json"];
const supportedMiscExtensions = [".3dl", ".exr", ".hdr"];
