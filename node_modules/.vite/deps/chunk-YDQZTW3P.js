...
var name5 = "openpbrDielectricReflectance";
var shader5 = `struct ReflectanceParams
...
var name6 = "openpbrConductorReflectance";
var shader6 = `#define pbr_inline
...
var name7 = "openpbrAmbientOcclusionFunctions";
var shader7 = `float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
var name8 = "openpbrGeometryInfo";
var shader8 = `struct geometryInfoOutParams
...
var name10 = "openpbrNormalMapFragment";
var shader10 = `vec2 uvOffset=vec2(0.0,0.0);
...
var name11 = "openpbrBlockNormalFinal";
var shader11 = `#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
var name12 = "openpbrBaseLayerData";
var shader12 = `vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
var name14 = "openpbrCoatLayerData";
var shader14 = `float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
var name15 = "openpbrThinFilmLayerData";
var shader15 = `#ifdef THIN_FILM
...
var name16 = "openpbrFuzzLayerData";
var shader16 = `float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
var name17 = "openpbrAmbientOcclusionData";
var shader17 = `vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
var name18 = "openpbrBackgroundTransmission";
var shader18 = `vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
var name19 = "openpbrEnvironmentLighting";
...
var name20 = "openpbrDirectLightingInit";
...
var name21 = "openpbrDirectLighting";
...
var name22 = "openpbrPixelShader";
var shader22 = `#define OPENPBR_FRAGMENT_SHADER
...
var openpbrPixelShader = { name: name22, shader: shader22 };

export {
  openpbrPixelShader
};
//# sourceMappingURL=chunk-YDQZTW3P.js.map
