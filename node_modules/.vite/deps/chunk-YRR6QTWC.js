...
var _WebAudioEngine = class extends AudioEngineV2 {
  ...
  async createBusAsync(name3, options = {}) {
    const module = await import("./webAudioBus-7PEAHB7S.js");
  ...
  async createMainBusAsync(name3, options = {}) {
    const module = await import("./webAudioMainBus-WQ4AOCTQ.js");
  ...
  async createSoundAsync(name3, source, options = {}) {
    const module = await import("./webAudioStaticSound-AXU6SKSA.js");
  ...
  async createSoundSourceAsync(name3, source, options = {}) {
    const module = await import("./webAudioSoundSource-73ZPATGF.js");
  ...
  async createStreamingSoundAsync(name3, source, options = {}) {
    const module = await import("./webAudioStreamingSound-BXHQ6PV5.js");
...
//# sourceMappingURL=chunk-YRR6QTWC.js.map
