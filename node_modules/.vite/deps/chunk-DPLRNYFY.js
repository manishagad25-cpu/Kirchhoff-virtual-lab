...
var shader2 = `#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
var name4 = "openpbrDielectricReflectance";
var shader4 = `struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
var shader6 = `fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
var name7 = "openpbrGeometryInfo";
var shader7 = `struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
var name9 = "openpbrNormalMapFragment";
var shader9 = `var uvOffset: vec2f= vec2f(0.0,0.0);
...
var name10 = "openpbrBlockNormalFinal";
var shader10 = `#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
var name11 = "openpbrBaseLayerData";
var shader11 = `var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
var name13 = "openpbrCoatLayerData";
var shader13 = `var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
var name14 = "openpbrThinFilmLayerData";
var shader14 = `#ifdef THIN_FILM
...
var name15 = "openpbrFuzzLayerData";
var shader15 = `var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
var name16 = "openpbrAmbientOcclusionData";
var shader16 = `var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
var name17 = "openpbrBackgroundTransmission";
var shader17 = `var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
var name18 = "openpbrEnvironmentLighting";
...
var name19 = "openpbrDirectLightingInit";
var shader19 = `#ifdef LIGHT{X}
...
var name20 = "openpbrDirectLighting";
...
var name21 = "openpbrPixelShader";
var shader21 = `#define OPENPBR_FRAGMENT_SHADER
...
var openpbrPixelShaderWGSL = { name: name21, shader: shader21 };

export {
  openpbrPixelShaderWGSL
};
//# sourceMappingURL=chunk-DPLRNYFY.js.map
