import {
  EffectWrapper
} from "./chunk-UQJ7RX4J.js";
import {
  PostProcessManager,
  RenderingManager,
  SmartArray
} from "./chunk-OFB6BJUJ.js";
import {
  PerfCounter
...
import {
  UniformBuffer
} from "./chunk-LZX4BTMY.js";
import {
  BaseTexture,
  Texture
} from "./chunk-NUBOQPHT.js";
import {
  SerializationHelper
} from "./chunk-TLKNTEWE.js";
import {
  __decorate,
  serialize,
  serializeAsColor4
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-KKBWAJAY.js").then((module) => this._dumpTools = module);
    }
...
function _GetCompatibleTextureLoader(extension, mimeType) {
  ...
  if (!RegisteredTextureLoaders.has(extension)) {
    ...
    if (extension.endsWith(".dds")) {
      registerTextureLoader(".dds", async () => await import("./ddsTextureLoader-GFE3DCG5.js").then((module) => new module._DDSTextureLoader()));
    }
    if (extension.endsWith(".basis")) {
      registerTextureLoader(".basis", async () => await import("./basisTextureLoader-WE3AKK2W.js").then((module) => new module._BasisTextureLoader()));
    }
    if (extension.endsWith(".env")) {
      registerTextureLoader(".env", async () => await import("./envTextureLoader-4ESDTKYJ.js").then((module) => new module._ENVTextureLoader()));
    }
    if (extension.endsWith(".hdr")) {
      registerTextureLoader(".hdr", async () => await import("./hdrTextureLoader-WM3KDVCT.js").then((module) => new module._HDRTextureLoader()));
    }
    if (extension.endsWith(".ktx") || extension.endsWith(".ktx2")) {
      registerTextureLoader(".ktx", async () => await import("./ktxTextureLoader-PA7WH7CH.js").then((module) => new module._KTXTextureLoader()));
      registerTextureLoader(".ktx2", async () => await import("./ktxTextureLoader-PA7WH7CH.js").then((module) => new module._KTXTextureLoader()));
    }
    ...
    if (extension.endsWith(".exr")) {
      registerTextureLoader(".exr", async () => await import("./exrTextureLoader-LPTN35UB.js").then((module) => new module._ExrTextureLoader()));
    }
  }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callbackAsync = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-CNZ6GGVV.js");
    const textures = [];
...
//# sourceMappingURL=chunk-XAWPMWE5.js.map
