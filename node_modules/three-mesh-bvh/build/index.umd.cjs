(function (global, factory) {
	...
	const IS_GT_REVISION_169$1 = parseInt( three.REVISION ) >= 169;
	const IS_LT_REVISION_161$1 = parseInt( three.REVISION ) <= 161;
	...
	const _uvA$1 = /* @__PURE__ */ new three.Vector2();
	const _uvB$1 = /* @__PURE__ */ new three.Vector2();
	const _uvC$1 = /* @__PURE__ */ new three.Vector2();

	const _normalA$1 = /* @__PURE__ */ new three.Vector3();
	const _normalB$1 = /* @__PURE__ */ new three.Vector3();
	const _normalC$1 = /* @__PURE__ */ new three.Vector3();
	...
	function checkBufferGeometryIntersection( ray, position, normal, uv, uv1, a, b, c, side, near, far ) {
		...
		if ( intersection ) {
			...
			if ( uv ) {
				...
				const res = three.Triangle.getInterpolation( _intersectionPoint, _vA, _vB, _vC, _uvA$1, _uvB$1, _uvC$1, intersection.uv );
			...
			if ( uv1 ) {
				...
				const res = three.Triangle.getInterpolation( _intersectionPoint, _vA, _vB, _vC, _uvA$1, _uvB$1, _uvC$1, intersection.uv1 );
				if ( ! IS_GT_REVISION_169$1 ) {
			...
			if ( normal ) {
				...
				const res = three.Triangle.getInterpolation( _intersectionPoint, _vA, _vB, _vC, _normalA$1, _normalB$1, _normalC$1, intersection.normal );
	...
	const _ray$4 = /* @__PURE__ */ new three.Ray();
	const _direction = /* @__PURE__ */ new three.Vector3();
	const _inverseMatrix$4 = /* @__PURE__ */ new three.Matrix4();
	...
	const _box$2 = /* @__PURE__ */ new three.Box3();
	...
	const _geometry = /* @__PURE__ */ new three.BufferGeometry();
	...
	const _mesh$1 = /* @__PURE__ */ new three.Mesh();
	...
	class ObjectBVH extends BVH {
		...
		constructor( root, options = {} ) {
			...
			options = {
				...
				matrixWorld: Array.isArray( root ) ? new three.Matrix4() : root.matrixWorld,
				maxLeafSize: 1,
				...options,
			};
	...
	const _localPoint = /* @__PURE__ */ new three.Vector3();
	const _axes = [ 'x', 'y', 'z' ];
					...
					if ( dist >= raycaster.near && dist <= raycaster.far ) {
						...
						const hit = {
							...
							face: {
								...
								b: bi,
								c: ci,
								normal: three.Triangle.getNormal( tri.a, tri.b, tri.c, new three.Vector3() ),
								materialIndex: 0
							},
							faceIndex: actualTri,
						};
						...
						if ( IS_GT_REVISION_169 ) {
							...
							const barycoord = new three.Vector3();
							three.Triangle.getBarycoord( _localPoint, tri.a, tri.b, tri.c, barycoord );
						...
						if ( uv ) {
							...
							hit.uv = new three.Vector2();
							const resUv = three.Triangle.getInterpolation( _localPoint, tri.a, tri.b, tri.c, _uvA, _uvB, _uvC, hit.uv );
						...
						if ( uv1 ) {
							...
							hit.uv1 = new three.Vector2();
							const resUv1 = three.Triangle.getInterpolation( _localPoint, tri.a, tri.b, tri.c, _uvA, _uvB, _uvC, hit.uv1 );
						...
						if ( normal ) {
							...
							const resNormal = three.Triangle.getInterpolation( _localPoint, tri.a, tri.b, tri.c, _normalA, _normalB, _normalC, hit.normal );
