export type DataType = 'Int8' | 'Int16' | 'Int32' | 'Entity' | 'Float32' | 'Float64' | 'Boolean' | 'String' | 'FilePath' | 'Object' | 'Vec2' | 'Vec3' | 'Vec4' | 'Color' | 'Enum';
...
export type TypeValueToType<T extends DataType> = T extends 'Int8' | 'Int16' | 'Int32' | 'Float32' | 'Float64' ? number : T extends 'Boolean' ? boolean : T extends 'String' | 'FilePath' | 'Enum' ? string : T extends 'Vec2' ? [number, number] : T extends 'Vec3' ? [number, number, number] : T extends 'Vec4' ? [number, number, number, number] : T extends 'Color' ? [number, number, number, number] : T extends 'Entity' ? import('./entity.js').Entity | null : T extends 'Object' ? unknown : never;
export type DataArrayToType<T extends DataType> = T extends 'Int8' | 'Int16' | 'Int32' | 'Entity' | 'Float32' | 'Float64' | 'Boolean' | 'Vec2' | 'Vec3' | 'Vec4' | 'Color' ? TypedArray : T extends 'String' | 'FilePath' | 'Enum' ? Array<string> : T extends 'Object' ? Array<unknown> : never;
