...
const CreateAerialPerspectiveCompositorEffectWrapper = (engine, uniformBuffer, isAerialPerspectiveLutEnabled, isSkyViewLutEnabled, isLinearSpaceComposition, applyApproximateTransmittance, aerialPerspectiveIntensity, aerialPerspectiveRadianceBias) => {
    ...
    return CreateEffectWrapper(engine, "atmo-aerialPerspectiveCompositor", "compositeAerialPerspective", ["depth", ...(useUbo ? [] : uniformBuffer.getUniformNames())], samplers, useUbo ? [uboName] : [], defines, useWebGPU, (_, list) => {
        list.push(...(useWebGPU
            ? [import("./ShadersWGSL/fullscreenTriangle.vertex.js"), import("./ShadersWGSL/compositeAerialPerspective.fragment.js")]
            : [import("./Shaders/fullscreenTriangle.vertex.js"), import("./Shaders/compositeAerialPerspective.fragment.js")]));
    });
};
/**
...
const CreateGlobeAtmosphereCompositorEffectWrapper = (engine, uniformBuffer, isSkyViewLutEnabled, isLinearSpaceComposition, applyApproximateTransmittance, aerialPerspectiveIntensity, aerialPerspectiveRadianceBias, hasDepthTexture) => {
    ...
    return CreateEffectWrapper(engine, "atmo-globeAtmosphereCompositor", "compositeGlobeAtmosphere", ["depth", ...(useUbo ? [] : uniformBuffer.getUniformNames())], samplers, useUbo ? [uboName] : [], defines, useWebGPU, (_, list) => {
        list.push(...(useWebGPU
            ? [import("./ShadersWGSL/fullscreenTriangle.vertex.js"), import("./ShadersWGSL/compositeGlobeAtmosphere.fragment.js")]
            : [import("./Shaders/fullscreenTriangle.vertex.js"), import("./Shaders/compositeGlobeAtmosphere.fragment.js")]));
    });
};
/**
